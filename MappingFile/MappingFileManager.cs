    ...
    public static class MappingFileManager
    {
        ...
        public static void NewWithDialog()
        {
            ...
            try
            {
                ...
                if (saveDlg.ShowDialog(Rhino.UI.RhinoEtoApp.MainWindow) != Eto.Forms.DialogResult.Ok)
                {
                    report = "❌ 新建映射文件取消";
                    return;
                }
        ...
        public static void LoadWithDialog()
        {
            ...
            try
            {
                ...
                if (openDlg.ShowDialog(Rhino.UI.RhinoEtoApp.MainWindow) != Eto.Forms.DialogResult.Ok)
                {
                    report = "❌ 映射文件加载取消";
                    return;
                }
        ...
        public static void SaveAsWithDialog()
        {
            ...
            try
            {
                ...
                if (saveDlg.ShowDialog(Rhino.UI.RhinoEtoApp.MainWindow) != Eto.Forms.DialogResult.Ok) return;
                string newPath = saveDlg.FileName;
